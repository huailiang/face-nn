...
namespace CFEngine
{
    ...
    [Serializable]
    public class RandomWindModify : IEnverimnentModify, IEnverimnentLerp, ISceneObject
    {
        public Vector4 WindPos;
        public AnimationCurve WindStrengthCurve;
        public float WindStrengthUpdateTime = 1;
        public AnimationCurve WindDirectionCurve;
        public float WindDirectionUpdateTime = 1;
        public Vector2 WindStrengthRange = new Vector2(0.1f, 0.2f);

        public Vector3 RotateAxis = new Vector3(0, 1, 0);
        public float StartAngle = 0;
        public float EndAngle = 0;
        public bool NeedWindStrengthReserve = true;
        public bool NeedWindDirectionReserve = true;

        [System.NonSerialized]
        public float m_windStrengthUpdateTime;
        [System.NonSerialized]
        public float m_windDirectionUpdateTime;
        [System.NonSerialized]
        public bool m_isWindStrengthReserve = false;
        [System.NonSerialized]

        public bool m_isWindDirectionReserve = false;
        [System.NonSerialized]
        public Vector4 m_windDir;
        ...
        public EnverimentModifyType GetEnvType()
        {
            return EnverimentModifyType.RandomWind;
        }
        public void Reset()
        {
    ...
    [Serializable]
    public class WaveWindModify : IEnverimnentModify, IEnverimnentLerp, ISceneObject
    {
        // public Vector4 windPlane = new Vector4 (1, 0, 0, 0);
        public float fastWindTime = 5.0f;
        public float slowWindScale = 3.0f;
        public float strength = 0.5f;
        public float strengthScale = 0.1f;

        [System.NonSerialized]
        public float windForceDelta = 0;

        [System.NonSerialized]
        public float forceScaleTime = 0;

        [System.NonSerialized]
        public float strengthLerp = 0;


        public EnverimentModifyType GetEnvType()
        {
            return EnverimentModifyType.WaveWind;
        }
        public void Reset()
        {
